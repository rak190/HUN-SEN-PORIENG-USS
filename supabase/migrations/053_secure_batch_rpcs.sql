...
-- Secure Permissions for Registration RPC
REVOKE EXECUTE ON FUNCTION public.batch_register_students_atomic(JSONB, UUID) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.batch_register_students_atomic(JSONB, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.batch_register_students_atomic(JSONB, UUID) TO service_role;
...
-- Secure Permissions for Score Upload RPC
REVOKE EXECUTE ON FUNCTION public.batch_upload_scores_atomic(JSONB, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.batch_upload_scores_atomic(JSONB, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.batch_upload_scores_atomic(JSONB, TEXT) TO service_role;
